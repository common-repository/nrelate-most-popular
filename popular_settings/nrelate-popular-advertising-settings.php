...
?>
    ...
    <script type="text/javascript">
		...
		var nr_mp_plugin_version = '<?php echo NRELATE_POPULAR_API_VERSION ?>';
		//]]>
    </script>
...
function update_nrelate_data_mp_adv(){
	...
	$body=array(
		...
		'PLUGIN_VERSION'=>NRELATE_POPULAR_PLUGIN_VERSION,
		'API_VERSION'=>NRELATE_POPULAR_API_VERSION,
		'KEY'=>get_option('nrelate_key')
	);
	$url = 'http://api.nrelate.com/mpw_wp/'.NRELATE_POPULAR_API_VERSION.'/processWPpopular_ad.php';
